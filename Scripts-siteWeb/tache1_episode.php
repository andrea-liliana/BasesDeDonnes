...
<form method="POST" action="#">
    <div class="form-row">
        ...
        <div class="col">
            <input name="duree" type="number" class="form-control" placeholder="Duree" >
        </div>

        <div class="col">
            <input name="synopsis" type="text" class="form-control" placeholder="Synopsis" >
        </div>
